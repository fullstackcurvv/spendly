...
<spec-name> e.g. /test-feature 05-rofile-backend"
...
- Read Source files for structure:
- Output test file to create:
  `tests/test_$ARGUMENTS`
...
- Spec file for context:
  `.claude/specs/$ARGUMENTS.md`
- Analyze source files against when diagnosing 
  failures
...
- Do NOT run any tests beyond `tests/test_$ARGUMENTS`
